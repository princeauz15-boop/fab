        ...
        <div className="container-custom relative z-10">
          ...
          >
            <motion.div variants={fadeUp} className="flex items-center gap-3 mb-4">
              ...
              <span className="text-[#c8922a] text-xs font-bold tracking-[0.2em] uppercase">Industries We Serve</span>
            </motion.div>
            <motion.h1
              variants={fadeUp}
            ...
            >
              Paper Tube{' '}
              <span className="text-[#c8922a]">Applications</span>
            </motion.h1>
            <motion.p variants={fadeUp} className="text-gray-400 text-base md:text-lg leading-relaxed">
              From textile winding to cracker manufacturing — our paper tubes serve diverse industrial needs with consistent precision.
            </motion.p>
