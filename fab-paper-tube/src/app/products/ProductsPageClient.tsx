  ...
  return (
    <div className="pt-20">
      <PageBanner
        ...
        highlight="Products"
        description="Reliable paper tube solutions for textile, packaging, cracker, candle and industrial applications. All manufactured to your specific requirements."
